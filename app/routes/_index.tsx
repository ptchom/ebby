  ...
  return (
    <RechnerLayout>
      <article className="bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100">
        ...
        <p className="my-2">
          Egal ob Sie versuchen, Ihre Renditen zu maximieren, Ihre Kreditzinsen
          zu berechnen, oder den Anteil Ihres Einkommens zu ermitteln, der nach
          Abzug der Steuern übrig bleibt, unser Ziel ist es, Ihnen bei all
          diesen Berechnungen zur Seite zu stehen.
        </p>

        <p className="my-2">
          Bei EB.BY bieten wir Ihnen verschiedene Online-Rechner, die flexibel
          und einfach zu bedienen sind. Unser Ziel ist es, Ihnen eine Plattform
          zu bieten, auf der Sie unabhängig von spezifischen Produktangeboten
        ...
        <p className="my-2">
          ...
          Möglichkeit, Ausdrucke für Ihre Kunden zu erstellen, auf denen auch
          Ihr Name steht.
        </p>

        <h3 className="my-2 text-xl font-semibold">Aktuelle Informationen</h3>
        <p className="my-2">
          Wir halten Sie auf dem Laufenden, was Änderungen oder Neuerungen bei
          den Online-Rechnern oder im Bereich Finanzen betrifft. Auf unserer
          Seite finden Sie regelmäßig aktualisierte Meldungen zu den wichtigsten
          Themen.
        </p>
        ...
        <p className="my-2">
          Indem Sie sich ein umfassendes Wissen aneignen und fundierte
          finanzielle Entscheidungen treffen, kommen Sie Ihren finanziellen
          Zielen einen Schritt näher. Bei EB.BY unterstützen wir Sie dabei -
          effizient, unabhängig und kostenfrei. Vertrauen Sie auf unsere
