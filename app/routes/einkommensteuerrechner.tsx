  ...
  return (
    <RechnerLayout>
      <article>
        ...
        <p>
          Der Einkommensteuerrechner auf unserer Webseite ist ein
          leistungsfähiges und benutzerfreundliches Instrument, das Ihnen hilft,
          Ihre Einkommensteuer schnell und genau zu berechnen.
        </p>

        <h3>Was macht unseren Einkommensteuerrechner so besonders?</h3>
        <p>
          Sie können mehrere Einkommen und Steuerklassen eingeben, um ein
          genaues Bild Ihrer steuerlichen Verhältnisse zu bekommen. Außerdem
        ...
        <h3>
          Kinderfreibetrag, Vorsorgeaufwendungen und außergewöhnliche
          Belastungen
        </h3>
        <p>
        ...
        <p>
          Unser Einkommensteuerrechner ist nicht nur sehr genau, er ist auch
          sehr benutzerfreundlich. Sie müssen lediglich Ihre Einkommen und
        ...
        <p>
          ...
          Berechnung Ihrer Einkommensteuer und sehen Sie, wie einfach es ist,
