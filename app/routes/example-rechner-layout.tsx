  ...
  return (
    <RechnerLayout>
      <article>
        ...
        <p>
          Der Kauf eines neuen Autos kann eine aufregende Erfahrung sein, aber
          es gibt viele Faktoren zu berücksichtigen. In dieser detaillierten
        ...
        <p>
          ...
          Budgetplanung. Sie sollten ein Budget festlegen, bevor Sie mit der
          Suche nach einem Auto beginnen, um sicherzustellen, dass Sie sich
          nicht zu stark verschulden.
        </p>

        <h2>Auswahl des richtigen Autos</h2>
        <p>
          Es gibt viele verschiedene Arten von Autos zur Auswahl, und Ihre
          Auswahl sollte auf Ihren spezifischen Bedürfnissen und Vorlieben
          basieren. Berücksichtigen Sie Faktoren wie Größe, Kraftstoffverbrauch,
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>Leasing</td>
              <td>
                Kleiner monatlicher Betrag, Option zum Kauf am Vertragsende
              </td>
            ...
            <tr>
              <td>Autokredit</td>
              <td>
                Auto gehört Ihnen am Ende der Laufzeit, keine
                Kilometerbegrenzung
              </td>
        ...
        <p>
          ...
          gewählt haben, können Sie den Kauf abschließen. Stellen Sie sicher,
          dass alle Papiere in Ordnung sind und Sie eine Versicherung
          abgeschlossen haben, bevor Sie das Auto vom Händler abholen.
        </p>

        <h3>Viel Erfolg beim Autokauf!</h3>
        <p>
          Mit diesen Tipps sollten Sie bestens vorbereitet sein, um ein neues
          Auto zu kaufen. Nehmen Sie sich die Zeit, um alle Optionen zu prüfen
          und das Auto zu wählen, das am besten zu Ihnen passt. Gute Fahrt!
        </p>
      </article>
    </RechnerLayout>
  );
