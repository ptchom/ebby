  ...
  return (
    <SecondLayout>
      <article>
        ...
        <p>
          Es gibt viele Arten von Häusern zur Auswahl, und die richtige Wahl
          hängt von einer Reihe von Faktoren ab, einschließlich Ihrer
          persönlichen Vorlieben, Ihrer Familiengröße und Ihren langfristigen
          Plänen.
        </p>
        ...
        <ul>
          <li>
            <strong>Einfamilienhäuser:</strong> Diese sind ideal für Familien,
            die viel Platz und Privatsphäre benötigen. Sie haben normalerweise
            einen eigenen Garten und sind frei stehend.
          </li>
          <li>
            <strong>Mehrfamilienhäuser:</strong> Diese sind perfekt für Anleger
            oder Eigentümer, die zusätzliches Einkommen durch Vermietung
            erzielen möchten.
          </li>
          <li>
