  ...
  return (
    <RechnerLayout>
      <article className="mx-auto p-5">
        ...
        <p>
          Die Informationen auf dieser Webseite wurden mit größtmöglicher
          Sorgfalt zusammengestellt. Dennoch kann keine Gewähr für die
          Aktualität, Richtigkeit, Vollständigkeit und Verfügbarkeit der
          dargestellten Informationen übernommen werden. Eine Haftung für direkt
          oder indirekt aus der Nutzung dieser Webseite entstehende Schäden kann
