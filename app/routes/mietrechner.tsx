...
export default function Mietrechner(): ReactElement {
  return (
    <article>
      ...
      <p>
        Unser Mietrechner ist ein leistungsstarkes Hilfsmittel, das Ihnen dabei
        hilft, Ihre monatlichen Mietkosten oder die Rentabilität eines
      ...
      <p>
        ...
        Vermieter, der die Mietrendite ermitteln will, sind - unser Mietrechner
        steht Ihnen zur Verfügung, um Sie dabei zu unterstützen. Starten Sie
        noch heute mit der Berechnung und nutzen Sie dieses Tool für Ihre
        Mietplanung!
      </p>
    </article>
  );
